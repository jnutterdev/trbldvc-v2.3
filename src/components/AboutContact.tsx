...
export default function AboutContact(props: SiteSettingsQuery) {
  ...
  return (
    <div className="panel p-sharp-br">
      <p className="panel-meta"><span>&#x25A0;</span> Reach out</p>
      <div className="contact-panel">
        <div className="contact-text">
          <h2 className="panel-heading">Contact</h2>
          <p>
            Corrections, recommendations, disagreements about whether{' '}
            <strong>Snow Crash counts as cyberpunk</strong> — all welcome.
            Response times vary. Signal quality not guaranteed.
          </p>
        </div>
